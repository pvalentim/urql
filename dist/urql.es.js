import { make, subscribe, onEnd, onPush, toPromise, take, share, filter, map, tap, merge, mergeMap, takeUntil, switchMap, fromValue, interval, makeSubject, onStart } from "wonka";

import { GraphQLError, parse, print, visit, Kind } from "graphql";

import { createContext, useContext, useRef, useState, useCallback, useLayoutEffect, useEffect, useMemo } from "react";
...
var useIsomorphicLayoutEffect = "undefined" != typeof window ? useLayoutEffect : useEffect;

var useImmediateState = function(init) {
  var isMounted = useRef(!1);
  var ref = useState(init);
  var state = ref[0];
  var setState = ref[1];
...
var useMutation = function(query, client) {
  ...
  return [ ref[0], useCallback(function(variables, context) {
    ...
    return toPromise(_client.executeMutation(request, context || {})).then(_ref);
...
var useQuery = function(args) {
  ...
  var executeQuery = useCallback(function(opts) {
    ...
    unsubscribe.current();
    setState(_ref$5);
    assign = subscribe(_ref2)(onEnd(_ref4)(client.executeQuery(request, _extends({
...
var useSubscription = function(args, handler) {
  ...
  var executeSubscription = useCallback(function(opts) {
    var assign;
    unsubscribe.current();
    setState(_ref$6);
    assign = subscribe(_ref2)(onEnd(_ref4)(client.executeSubscription(request, _extends({}, args.context, opts)))), 
